  ...
  return (
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
          ...
          <p className="text-gray-500 mb-4">
            Be the first to hear about new products, exclusive evens, and online offer.
          </p>
          ...
          <form className="flex">
            <input type="email" placeholder="Enter your email"
                    className="p-3 w-50 text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all" required>
            </input>
      ...
      <div className='container mx-auto mt-12 lg:px-0 border-t border-gray-200 pt-6'>
        <p className='text-gray-500 text-sm tracking-tighter text-center'>@ 2025, CompileTab. All Rights Reserverd.</p>
      </div>
    </footer>
  )
}
