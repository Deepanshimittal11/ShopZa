    ...
    <footer className="border-t p-12">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">  
            <div>
                ...
                <p className="font-medium text-sm text-gray-600 mb-6">Sign up and get upto 10% off on your first order.</p>
                {/* Newsletter Form */}
                <form className="flex">
                    <input type="emial" placeholder="Enter your Email"
                     ...
                     focus:outline-none focus:ring-2 foucs:ring-gray-500 transition-all" required />
        ...
        <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
            <p className="text-gray-500 text-sm tracking-tighter text-center">
                <MdCopyright className="inline-block" /> 2025, CompileTab. All Rights Reserved.
            </p>
        </div>
    </footer>
  )
