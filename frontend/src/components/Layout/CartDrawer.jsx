...
const CartDrawer = ( {drawerOpen, toggleCartDrawer}) => {
  ...
  <div className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-[30rem] h-full bg-white shadow-lg 
            transform transition-transform duration-300 flex flex-col z-50 ${drawerOpen ? 
            "translate-x-0" : "translate-x-full"}`}>
                ...
                <div className="flex-grow p-4 overflow-y-auto">
                    <h2 className="text-xl font-semibold mg-4">Your cart</h2>
                    {/* component of cart contents */}
                    <CartContents />
                </div>
