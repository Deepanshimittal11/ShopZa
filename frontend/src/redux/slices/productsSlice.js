...
// Async Thunk to fetch Products by vollection and optional filters
...
const productsSlice = createSlice({
    name: "products",
    initialState: {
        products: [], //Store all the fetch products
        selectedProduct: null, // this will keep the track of currently viewed product
        similarProducts: [],
        loading: false,
        error: null,
        filters: {
